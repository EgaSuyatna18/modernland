...
<body>
    <nav class="navbar navbar-expand-lg" style="background-color: #94ec8c;">
        <div class="container-fluid">
          <a class="navbar-brand" href="/dashboard">Pasar Modernland</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/pesanan/baru">Pesanan Baru</a></li>
                  <li><a class="dropdown-item" href="/pesanan/siap">Pesanan Siap</a></li>
                  <li><a class="dropdown-item" href="/pesanan/selesai">Pesanan Selesai</a></li>
                </ul>
              </li>
            </ul>
